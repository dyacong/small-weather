package cn.edu.pku.dongyacong.miniweather1;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCitySelct=(ImageView) findViewById(R.id.title_city_manager);
        mCitySelct.setOnClickListener(this);
